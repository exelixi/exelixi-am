...
import xyz.exelixi.interp.GeneratorFilterHelper;
import xyz.exelixi.interp.VariableLocation;
...
public class VariableOffsetTransformer extends AbstractBasicTransformer<VariableOffsetTransformer.LookupTable> {
	...
	public static ActorMachine transformActorMachine(ActorMachine actorMachine) throws CALCompiletimeException {
		VariableOffsetTransformer transformer = new VariableOffsetTransformer();
		ActorMachineTransformerWrapper<LookupTable> wrapper = new ActorMachineTransformerWrapper<LookupTable>(transformer);
	...
	public class NetDefVarOffsetTransformer extends NetworkDefinitionTransformerWrapper<LookupTable>{
