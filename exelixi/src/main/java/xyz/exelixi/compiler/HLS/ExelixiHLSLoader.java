 ...
 */
public interface ExelixiHLSLoader extends Loader {

    static Loader instance(Configuration configuration, Reporter reporter) {
        return new CombinedLoader(Arrays.asList(
                new CalLoader(reporter, configuration.get(ExelixiHLSCompiler.sourcePaths), configuration.get(followLinks)),
                new OrccLoader(reporter, configuration.get(ExelixiHLSCompiler.orccSourcePaths), configuration.get(followLinks)),
                new XdfLoader(reporter, configuration.get(ExelixiHLSCompiler.xdfSourcePaths)),
