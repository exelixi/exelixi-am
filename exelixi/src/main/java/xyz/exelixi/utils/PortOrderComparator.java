...
/**
 * String Port order Comparator
 *
 * @Endri Bezati
 */
public class PortOrderComparator implements Comparator<String> {

    private List<String> sortOrder;

    public PortOrderComparator(List<String> sortOrder) {
        this.sortOrder = sortOrder;
    }

    @Override
    public int compare(String A, String B) {
        Integer portPositionA = sortOrder.indexOf(A);
        Integer portPositionB = sortOrder.indexOf(B);

        return portPositionA.compareTo(portPositionB);
    }
}
